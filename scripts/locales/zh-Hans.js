window.WWM_MESSAGES = {
  ...
  checklist: {
    locale: 'zh-CN', completed: '完成', activity: '活动', category: '类别', priority: '优先级', rewards: '主要奖励 / 目标', time: '用时', deadline: '截止日期',
    sortCompletion: '按完成状态排序', sortCategory: '按活动类别排序', sortPriority: '按优先级排序', sortTime: '按用时排序',
    markCompleted: name => `标记${name}完成`, monthly: '每月', guild: '百业活跃', details: '展开详情',
    guide: '做法 / 攻略', notes: '备注', none: '暂无', loading: '正在载入限时活动…',
    loadError: '限时活动载入失败，请刷新页面重试。', empty: '没有符合当前筛选条件的活动。',
    lessThanDay: '不足 1 天', remainingDays: days => `剩余 ${days} 天`,
    progress: { Limited: '限时活动进度', Daily: '今日进度', Recurring: '本周 / 本月进度' },
    beijingTime: (hour, minute) => `北京时间 ${hour}:${minute}`,
    reset: { Limited: '完成状态按各活动规则重置', Daily: '每日 05:00 重置', Recurring: '每周一 / 每月1日 05:00 重置' }
  }
};
